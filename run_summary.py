...
def process_summary_data():
    ...
    try:
        ...
        # Convert 0000 to OPEN (if any exist)
        trigger_occurrences['TriggerTime'] = trigger_occurrences['TriggerTime'].replace('0000', 'OPEN')
        # Convert 4-digit times to OPEN if they represent market open (930 or earlier)
        trigger_occurrences.loc[trigger_occurrences['TriggerTime'].str.match(r'^9[0-3][0-9]
        ...
        # Convert 0000 to OPEN (if any exist)
        goal_hits['TriggerTime'] = goal_hits['TriggerTime'].replace('0000', 'OPEN')
        goal_hits['GoalTime'] = goal_hits['GoalTime'].replace('0000', 'OPEN')
        
        # Convert early morning times to OPEN (930 and earlier)
        goal_hits.loc[goal_hits['TriggerTime'].str.match(r'^9[0-3][0-9]
...
""")
, na=False), 'TriggerTime'] = 'OPEN' 
        goal_hits.loc[goal_hits['GoalTime'].str.match(r'^9[0-3][0-9]
